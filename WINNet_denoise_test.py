...
def main():
    ...
    while epoch <= opt.end_epoch:
        print('Load model epoch %d' % epoch)
        model.load_state_dict(torch.load(os.path.join(opt.logdir, 'net_WINNet_epoch_{}.pth'.format(epoch))))
        ...
        for f in files_source:
            ...
            # save results
            if opt.show_results:
                save_out_path = "results/WINNet/epoch_{}_img_{}.png".format(epoch, i)
